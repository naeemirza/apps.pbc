...
class _ItemViewState extends State<ItemView> {
  ...
  Widget build(BuildContext context) {
    // if (homeController.itemDetailsData.value.itemAttributes!.isNotEmpty) {
    //   homeController.itemDetailsData.value.itemAttributes!.forEach((e) {
    //     variationList.add(
    //       (Variations(
    //         id: homeController.itemDetailsData.value.variations[e.id.toString()]
    //             [0]['id'],
    //         itemAttributeId: int.parse(homeController.itemDetailsData.value
    //             .variations[e.id.toString()][0]['item_attribute_id']
    //             .toString()),
    //         name: homeController
    //             .itemDetailsData.value.variations[e.id.toString()][0]['name'],
    //         variationName:
    //             homeController.itemDetailsData.value.itemAttributes![0].name,
    //         price: double.parse(homeController.itemDetailsData.value
    //             .variations[e.id.toString()][0]['convert_price']
    //             .toString()),
    //       )),
    //     );
    //   });
