                      ...
                      Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  if (widget.isGuest == false && widget.forgetPassword == false)
                                  {
                                    authController.phoneNumberSignUp(widget.phoneNumber);
                                  }
                                  else if (widget.isGuest == true && widget.forgetPassword == false)
                                  {
                                    authController.phoneNumberSignUp(widget.phoneNumber);
                                  }
                                  else if(widget.forgetPassword == true && widget.isGuest == false){
                                    authController
